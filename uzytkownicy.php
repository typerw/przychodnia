<?php
	...
	$zamien = $conn->query("SELECT `nazwa` FROM `Uzytkownicy`");
...
<H4><center>Baza uzytkowników</center></H4>
	...
	<form action="uzytkownicy.php" method="get">
		...
		<label><input type="radio" name="menu" value="1" checked> Dodaj nowego użytkownika do bazy <label><br>
		</div>
		<div class="form-group">
		Nazwa: <input type="text" class="form-control" name="nazwa" placeholder="Wpisz nazwe nowego użytkownika"><br>
		Email: <input type="text" class="form-control" name="email" placeholder="Wpisz email nowego użytkownika"><br>
		Hasło<input type="password"  class="form-control" name="haslo" placeholder="Wpisz hasło nowego użytkownika"><br>
		Status<input type="text" class="form-control" name="status" placeholder="Wpisz status nowego użytkownika"><br>
		</div>
		<div class="form-group">
